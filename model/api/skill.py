...
class Skill:
    ...
    def __init__(self, data: dict = None) -> None:
        if(data is not None):
            ...
            self.categories = [self._get_category(x) for x in get_list_or_empty('categories')]
            ...
            self.transform_skills = [int(x) for x in get_list_or_empty('transform_skills', data)]
            self.bundle_skills = [int(x) for x in get_list_or_empty('bundle_skills', data)]
            self.toolbelt_skill = [int(x) for x in get_list_or_empty('toolbelt_skill', data)]
            self.flags = [SkillFlag[x] for x in get_list_or_empty('flags', data)]
